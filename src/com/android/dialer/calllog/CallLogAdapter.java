...
public class CallLogAdapter extends GroupingListAdapter
     ...
     */
    public void setTempPhoneCallDetails(CallLogListItemViews views, Cursor c, int count,
                                        String number, long date) {
        final String formattedNumber = c.getString(CallLogQuery.CACHED_FORMATTED_NUMBER);
        views.phoneCallDetailsViews.nameView
                .setText(TextUtils.isEmpty(formattedNumber) ? number : formattedNumber);
